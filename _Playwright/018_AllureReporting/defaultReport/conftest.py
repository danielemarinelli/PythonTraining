...
# this fixture will run after all the tests are executed and before generating report
...
def pytest_runtest_makereport(item, call):
    ...
    if report.when == "call":
        ...
        # for attaching the screenshot to the report , if test fails
        # so we can comment the line of screenshots in pytest.ini file
