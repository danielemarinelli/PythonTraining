...
xlsx_file_path = user_home / "PycharmProjects" / "PythonSelenium" / "_Playwright" / "017_DDT" / "testdata" / "data.xlsx"
workbook=openpyxl.load_workbook(xlsx_file_path)
sheet=workbook.active    # or  worksheet["Sheet_name"]

# reading data from excel sheet using for loop
for row in sheet.iter_rows(min_row=2, values_only=True):  # start from row 2 because the first one has headers
