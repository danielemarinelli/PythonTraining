...
class LoginPage:  # a function inside a class must always contain 'self' keyword
    def __init__(self, page: Page):  # all locators will be inside the constructor
        self.page = page  # every variable is referring to the class, so must insert self.<name_var> infront
    ...
    # method combine in one single time the login
